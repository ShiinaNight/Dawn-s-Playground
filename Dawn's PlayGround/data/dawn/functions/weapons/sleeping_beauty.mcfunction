...
# 蓄力攻击5s后眩晕
scoreboard players set @s[scores={dawnSkillTim=50..}] dawnSnkTim -1
scoreboard players set @s[scores={dawnSkillTim=50..}] dawnFaint 70
execute as @s[scores={dawnFaint=1..,dawnSnkTim=..0}] run function dawn:skills/sleeping_beauty_faint
# 持续减少技能持续时间（眩晕槽）
