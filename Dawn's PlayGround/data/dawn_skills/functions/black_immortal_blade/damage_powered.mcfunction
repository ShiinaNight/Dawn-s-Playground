...
execute at @e[tag=immortal_blade,limit=1] run playsound item.totem.use player @a ~ ~ ~ 1 0.3
execute at @e[tag=immortal_blade,limit=1] run playsound item.totem.use player @a ~ ~ ~ 1 0.1