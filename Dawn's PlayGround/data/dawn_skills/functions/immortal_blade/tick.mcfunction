...
# 触发
execute as @a[predicate=dawn:offhand/skills/immortal_blade] unless score @s dawnSkillTim matches 1.. if score @s dawnSkillPoint matches 400.. if score @s skill_trigger matches 1.. at @s run function dawn_skills:immortal_blade/start
execute as @a[predicate=dawn:offhand/skills/immortal_blade] unless score @s dawnSkillTim matches 1.. unless score @s dawnSkillPoint matches 400.. if score @s skill_trigger matches 1.. at @s run function dawn_skills:immortal_blade/warn
